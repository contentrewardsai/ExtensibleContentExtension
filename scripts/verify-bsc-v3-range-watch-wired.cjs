...
const checks = [
  ...
  [docs, 'runWorkflow', 'docs: monitor children are runWorkflow steps'],
  [wf, 'waitUntilOutOfRange', 'workflow bundle: one-shot range watch'],
  [wf, 'reconcileV3Positions', 'workflow bundle: reconcile step'],
  ...
  [steps, 'reconcileV3Positions', 'steps manifest: reconcileV3Positions'],
  [ids, 'reconcileV3Positions', 'crypto step ids: reconcile'],
  [watch, 'planMonitorTick', 'v3-range-watch: SW-safe tick planner'],
  [watch, 'hasMatchingRunWorkflowChildren', 'v3-range-watch: steps vs onOutOfRange'],
