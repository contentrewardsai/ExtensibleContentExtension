...
(function (global) {
  ...
  var BUILTIN_CHECKLIST = [
    ...
    { section: 'Extension & Dev', id: 'tests-button', label: 'Settings / unit tests page', desc: 'Side panel: Settings opens settings.html on Advanced (MCP). Use the Tests tab for unit pass/fail + checklist, or Open unit tests page for test/unit-tests.html with Run crypto tests panel + full suite + checklist.', snippet: null },
    ...
    { section: 'Optional', id: 'library-transcribe', label: 'Library Transcribe', desc: 'Library → Transcribe: pick or select an audio/video file and transcribe with Whisper.', snippet: null },
  ];
