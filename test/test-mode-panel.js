...
(function (global) {
  ...
  var BUILTIN_CHECKLIST = [
    ...
    { section: 'Extension & Dev', id: 'tests-button', label: 'Settings / unit tests page', desc: 'Side panel: Settings opens settings.html (scroll to Tests for unit pass/fail + checklist, or Open unit tests page for test/unit-tests.html with Run crypto tests panel + full suite + checklist).', snippet: null },
