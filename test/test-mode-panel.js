...
(function (global) {
  ...
  var BUILTIN_CHECKLIST = [
    ...
    { section: 'Extension & Dev', id: 'tests-button', label: 'Settings / Unit tests', desc: 'Side panel: Settings opens settings.html (scroll to Tests for unit pass/fail + checklist, or Open unit tests page). Unit tests opens test/unit-tests.html directly (Run crypto tests panel + full suite + checklist).', snippet: null },
