...
```json
{
  ...
  "e2e": {
    "workflowId": "e2e-test-writeJsonToProject",
    "rows": [{ "projectId": "default", "filename": "test-output.json" }],
    "assert": "smoke",
...
3. **Manual**: For full verification, run a workflow with **Write JSON to project** or **Download**, then confirm files under **`uploads/{projectId}/generations/`** (or your step **folder** name) in the project directory.
