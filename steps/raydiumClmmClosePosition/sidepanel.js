(function() {
  ...
  window.__CFS_registerStepSidepanel('raydiumClmmClosePosition', {
    label: 'Raydium CLMM close position',
    defaultAction: {
    ...
    getSummary: function(action) {
      ...
      return n ? 'CLMM close ' + n.slice(0, 6) + '…' : 'Raydium CLMM close position';
    },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        '<p class="step-hint">Liquidity must be 0. Decrease first, or use decrease with close.</p>' +
      ...
      return window.__CFS_buildStepItemShell('raydiumClmmClosePosition', action, i, totalCount, helpers, body);
    },
    saveStep: function(item, action, idx) {
      ...
      var out = { type: 'raydiumClmmClosePosition' };
