(function() {
  ...
  window.__CFS_registerStepSidepanel('raydiumAddLiquidity', {
    label: 'Raydium add liquidity',
    defaultAction: {
    ...
    getSummary: function(action) {
      ...
      return p ? 'Raydium LP + ' + p.slice(0, 8) + '…' : 'Raydium add liquidity';
    },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        '<p class="step-hint">Standard AMM pools only (need <code>marketId</code>). Not CLMM/CPMM.</p>' +
      ...
      return window.__CFS_buildStepItemShell('raydiumAddLiquidity', action, i, totalCount, helpers, body);
    },
    saveStep: function(item, action, idx) {
      ...
      var out = { type: 'raydiumAddLiquidity' };
