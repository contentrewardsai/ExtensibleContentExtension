(function () {
  ...
  window.__CFS_registerStepSidepanel('solanaWatchReadActivity', {
    label: 'Solana watch read activity',
    defaultAction: {
      type: 'solanaWatchReadActivity',
      runIf: '',
      limit: '40',
      applyClientFilters: true,
      filterAddress: '',
      sinceTimestampMs: '',
      saveResultVariable: 'solanaWatchActivity',
    },
    getSummary: function (action) {
      var lim = String(action.limit || '40').trim() || '40';
      return 'Solana watch: read activity (limit ' + lim + ')';
    },
