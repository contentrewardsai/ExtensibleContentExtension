(function() {
  ...
  window.__CFS_registerStepSidepanel('raydiumClmmLockPosition', {
    label: 'Raydium CLMM lock position',
    defaultAction: {
    ...
    getSummary: function(action) {
      ...
      return n ? 'CLMM lock ' + n.slice(0, 6) + '…' : 'Raydium CLMM lock position';
    },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        '<p class="step-hint">Creates lock NFT; use harvest step with lock mint afterward.</p>' +
      ...
      return window.__CFS_buildStepItemShell('raydiumClmmLockPosition', action, i, totalCount, helpers, body);
    },
    saveStep: function(item, action, idx) {
      ...
      var out = { type: 'raydiumClmmLockPosition' };
