(function() {
  ...
  window.__CFS_registerStepSidepanel('meteoraCpammRemoveLiquidity', {
    label: 'Meteora CP-AMM remove liquidity',
    defaultAction: {
    ...
    getSummary: function(action) {
      ...
      return pos ? 'Meteora CP-AMM − ' + pos.slice(0, 8) + '…' : 'Meteora CP-AMM remove liquidity';
    },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        '<p class="step-hint">Closes the position after removing liquidity. Locked / vesting positions may fail.</p>' +
      ...
      return window.__CFS_buildStepItemShell('meteoraCpammRemoveLiquidity', action, i, totalCount, helpers, body);
    },
    saveStep: function(item, action, idx) {
      ...
      var out = { type: 'meteoraCpammRemoveLiquidity' };
