(function() {
  ...
  window.__CFS_registerStepSidepanel('meteoraCpammClaimFees', {
    label: 'Meteora CP-AMM claim fees',
    defaultAction: {
    ...
    getSummary: function(action) {
      ...
      return pos ? 'Meteora CP-AMM fees ' + pos.slice(0, 8) + '…' : 'Meteora CP-AMM claim fees';
    },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        '<p class="step-hint">Claims LP fees only; position stays open.</p>' +
      ...
      return window.__CFS_buildStepItemShell('meteoraCpammClaimFees', action, i, totalCount, helpers, body);
    },
    saveStep: function(item, action, idx) {
      ...
      var out = { type: 'meteoraCpammClaimFees' };
