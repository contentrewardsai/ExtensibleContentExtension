...
(function() {
  ...
  window.__CFS_registerStepHandler('bscQuery', async function(action, opts) {
    ...
    var msg = {
      ...
      tick: trimResolved(row, getRowValue, action, action.tick),
      ...
      decimals0: trimResolved(row, getRowValue, action, action.decimals0),
      decimals1: trimResolved(row, getRowValue, action, action.decimals1),
      tickSpacing: trimResolved(row, getRowValue, action, action.tickSpacing),
      wordRange: trimResolved(row, getRowValue, action, action.wordRange),
      maxTicks: trimResolved(row, getRowValue, action, action.maxTicks),
      rangePercent: trimResolved(row, getRowValue, action, action.rangePercent),
      bnbBudget: trimResolved(row, getRowValue, action, action.bnbBudget),
      bnbBudgetWei: trimResolved(row, getRowValue, action, action.bnbBudgetWei),
      gasReserveWei: trimResolved(row, getRowValue, action, action.gasReserveWei),
      driftDirection: trimResolved(row, getRowValue, action, action.driftDirection),
      from: trimResolved(row, getRowValue, action, action.from),
