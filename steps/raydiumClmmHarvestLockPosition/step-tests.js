/**
 * Unit tests for raydiumClmmHarvestLockPosition — payload shape mirrors handler.js.
 */
(function (global) {
  'use strict';
  ...
  runner.registerStepTests('raydiumClmmHarvestLockPosition', [
    { name: 'payload type', fn: function () {
      ...
      runner.assertEqual(p.type, 'CFS_RAYDIUM_CLMM_HARVEST_LOCK_POSITION');
    }},
    { name: 'template resolution', fn: function () {
      var row = { nft: 'MINT123' };
      var p = buildPayload({ positionNftMint: '{{nft}}' }, row);
      runner.assertEqual(p.positionNftMint, 'MINT123');
    }},
