(function() {
  ...
  window.__CFS_registerStepSidepanel('raydiumClmmIncreasePosition', {
    label: 'Raydium CLMM increase position',
    defaultAction: {
    ...
    getSummary: function(action) {
      ...
      return n ? 'CLMM +liq ' + n.slice(0, 6) + '…' : 'Raydium CLMM increase position';
    },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        '<p class="step-hint">Existing position only. otherAmountMaxRaw is a spend cap on the paired token.</p>' +
      ...
      return window.__CFS_buildStepItemShell('raydiumClmmIncreasePosition', action, i, totalCount, helpers, body);
    },
    saveStep: function(item, action, idx) {
      ...
      var out = { type: 'raydiumClmmIncreasePosition' };
