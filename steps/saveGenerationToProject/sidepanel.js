(function() {
  ...
  window.__CFS_registerStepSidepanel('saveGenerationToProject', {
    ...
    defaultAction: { type: 'saveGenerationToProject', variableName: 'generatedImage', projectIdVariable: '{{projectId}}', folder: 'generations', namingFormat: 'numeric' },
    ...
    renderBody: function(action, i, wfId, totalCount, helpers) {
      ...
      var body =
        ...
        '<div class="step-field"><label>Subfolder under project</label><input type="text" data-field="folder" data-step="' + i + '" value="' + escapeHtml(folder) + '" placeholder="generations"></div>' +
