...
**Optional CI secrets:** `SOLANA_RPC_SMOKE_URL`, `BSC_RPC_SMOKE_URL`, `CRYPTO_EVM_FORK_RPC_URL` — see [CRYPTO_CI_SMOKE.md](./CRYPTO_CI_SMOKE.md). RPC smoke runs if **either** Solana or BSC URL is set.
